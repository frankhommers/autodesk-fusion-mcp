...
from . import doc_lookup, operations, python_exec, tool_surface
...
def create_server():
    set_tool_handler(operations.handle_tool_call)

    server = mcp_server_module.MCPServer(
        port=settings.MCP_SERVER_PORT,
        tool_handler=dispatch_to_main_thread,
        tool_name=settings.MCP_TOOL_NAME,
        tool_description=tool_surface.tool_description(),
        tool_input_schema=tool_surface.tool_input_schema(),
        log_callback=log,
    )
