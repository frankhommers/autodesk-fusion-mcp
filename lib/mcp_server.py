...
MCP clients connect directly:
  {"mcpServers": {"autodesk_fusion": {"type": "http", "url": "http://localhost:8765/mcp"}}}
...
class MCPServer:
    ...
    def start(self):
        ...
        class MCPRequestHandler(BaseHTTPRequestHandler):
            ...
            def _handle_tools_list(self, params):
                ...
                return {
                    "tools": [
                        {
                            "name": server_ref.tool_name,
                            "description": server_ref.tool_description,
                            "inputSchema": server_ref.tool_input_schema,
                        }
                    ]
                }
            ...
            def _handle_tools_call(self, params):
                ...
                if tool_name != server_ref.tool_name:
                    return {
                        "content": [
                            {
                                "type": "text",
                ...
                if not server_ref.tool_handler:
                    return {
                        "content": [
                            {
                                "type": "text",
                                "text": "Tool handler not configured",
                            }
                        ],
                        "isError": True,
                    }
                ...
                call_data = {"params": {"arguments": arguments}}
                return server_ref.tool_handler(call_data)
        ...
        try:
            ...
            self.log(
                f'  "autodesk_fusion": {{"type": "http", "url": "http://127.0.0.1:{self.port}/mcp"}}'
            )
